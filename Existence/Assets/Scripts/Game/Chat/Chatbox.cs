...
#region Unity Functions
    ...
    private void Start() {
        ...
        if (network) {
            ...
            network.chatEvt.OnMsg += OnChat;
            network.addInventoryEvt.OnMsg += OnInventoryAdded;
            network.addInventoryFailEvt.OnMsg += OnAddInventoryFail;
            network.mobHitEvt.OnEvt += OnPlayerHit;
            network.mobAttackStartEvt.OnEvt += OnMobAttackStart;
            network.playerHitEvt.OnEvt += OnMobHit;
