...
#region Public Functions
            public void PlayAudio(AudioType _type, bool _fade=false, float _maxVolume=1, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.START, _type, _fade, _maxVolume, _delay));
            }

            public void StopAudio(AudioType _type, bool _fade=false, float _maxVolume=1, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.STOP, _type, _fade, _maxVolume, _delay));
            }

            public void RestartAudio(AudioType _type, bool _fade=false, float _maxVolume=1, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.RESTART, _type, _fade, _maxVolume, _delay));
            }
#endregion
...
#region Private Functions
            ...
            private IEnumerator RunAudioJob(AudioJob _job) {
                ...
                // fade volume
                if (_job.fade) {
                    float _initial = _job.action == AudioAction.START || _job.action == AudioAction.RESTART ? 0 : _job.maxVolume;
                    float _target = _initial == 0 ? _job.maxVolume : 0;
