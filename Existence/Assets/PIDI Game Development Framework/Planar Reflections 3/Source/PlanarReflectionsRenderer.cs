...
namespace PlanarReflections3 {
    ...
    public class PlanarReflectionsRenderer : MonoBehaviour {
        ...
        public void RenderReflection( Camera srcCamera ) {
            ...
            currentReflector.refCamera.enabled = SRPMode;
                ...
                if ( !SRPMode ) {
                    ...
                    if ( !currentReflector.assignedTexture ) {
                        ...
                        if ( !currentReflector.assignedTexture || currentReflector.assignedTexture.width != width || currentReflector.assignedTexture.height != height ) {
                            ...
                            //DestroyImmediate( currentReflector.assignedTexture );
#if PLANAR3_PRO
                            if ( settings.forceFloatOutput && settings.usePostFX ) {
                                reflectionTex = RenderTexture.GetTemporary( new RenderTextureDescriptor( width, height, RenderTextureFormat.ARGBFloat, 24 ) );
            ...
            if ( !SRPMode && Settings.customShadowDistance ) {
                ...
                currentReflector.camData.renderShadows = false;
            }
#endif
            ...
            if ( SRPMode ) {
                if ( Settings.usePostFX ) {
#if PLANAR3_URP
                    UnityEngine.Rendering.Universal.UniversalAdditionalCameraData refPostFX = Settings.PostFXSettingsMode == PostFXSettingsMode.CustomSettings ? currentReflector.camData : srcCamera.GetComponent<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>();
#elif PLANAR3_HDRP
                    UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData refPostFX = Settings.PostFXSettingsMode == PostFXSettingsMode.CustomSettings ? currentReflector.camData : srcCamera.GetComponent<UnityEngine.Rendering.HighDefinition.HDAdditionalCameraData>();
#endif
                    if ( refPostFX ) {

#if PLANAR3_URP
                        UnityEngine.Rendering.Universal.UniversalAdditionalCameraData targetPostFX = currentReflector.camData;
#elif PLANAR3_HDRP
                        ...
                        if ( targetPostFX ) {
                            ...
                            targetPostFX.renderPostProcessing = true;
        ...
        public void OnDrawGizmos() {
            ...
            if ( AssetDatabase.FindAssets( "Planar3Logo_Gizmos" ).Length < 1 ) {
                ...
                var path = AssetDatabase.GetAssetPath( sceneIcon );
                AssetDatabase.MoveAsset( path, "Assets/Gizmos/Planar3Logo_Gizmos.png" );
#else
